/* eslint-disable */
/**
 * Copied as-is from https://github.com/react-native-device-info/react-native-device-info/tree/master/example
 */

import React, { Component, useCallback, memo } from "react";
import { ScrollView, StyleSheet, Text, SafeAreaView, View, TouchableOpacity, NativeModules } from "react-native";
  ...
  render() {
    return (
      <SafeAreaView style={styles.container}>
        <ActionExtensionHeader isActionExtension={this.props.isActionExtension} />
        {this.state.activeTab === "constant" ? (
          ...
          <>
            <Text style={styles.welcome}>react-native-device-info example - hooks:</Text>
            <FunctionalComponent />
          </>
        ) : null}
        ...
        <View style={styles.tabBar}>
          <TouchableOpacity
            ...
            <Text style={[styles.tabText, this.state.activeTab === "constant" && styles.boldText]}>Constant</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <Text style={[styles.tabText, this.state.activeTab === "sync" && styles.boldText]}>Sync</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <Text style={[styles.tabText, this.state.activeTab === "async" && styles.boldText]}>Async</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <Text style={[styles.tabText, this.state.activeTab === "hooks" && styles.boldText]}>Hooks</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    );
